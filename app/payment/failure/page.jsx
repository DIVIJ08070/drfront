...
function FailureDetails() {
  ...
  return (
    <>
      ...
      <main>
        <div className="card">
          <div className="badge">FAILURE</div>

          <h1>Payment Failed</h1>
          <p style={{ color: '#4b5563' }}>Your transaction could not be completed. Please check your details and try again.</p>
...
export default function PayuFailurePage() {
    // This function must exist to wrap the component that uses useSearchParams()
    return (
